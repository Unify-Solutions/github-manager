locals {
  ...
  repositories_list = [
    ...
    {
      name        = "UnifyTickerTool"
      description = "Tool which provides insights into financial markets with a hint of hype."
      topics      = ["cs", "server", "clients", "finance", "terraform"]
    ...
    {
      name        = "Unify-Claude-Plugins"
      description = "Claude Code plugins and skills to be used across the Unify-Solutions organisation."
      topics      = ["claude", "markdown", "skills", "plugins", "cli"]
